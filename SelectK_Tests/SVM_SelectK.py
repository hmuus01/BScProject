...
#Store the length of the above features
lengt = range(1, len(features) + 1)
...
for alg in algs:
    ...
    for k in lengt:
        ...
        for rs in random_seeds:
            ...
            # use sklearn to split the X and y, into X_train, X_test, y_train y_test with 80/20 split cache_size=7000
